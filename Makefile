...
vcd: analize
	...
	ghdl -r processor_testbench --vcd=result.vcd --stop-time=200ns

analize:
	ghdl -a datapath/datapath_bib.vhdl mux/mux2x1n.vhd sign_ext/sign_ext.vhd sll2bit/sll2bit.vhd ripple_carry_adder/ripple_carry_adder.vhd ripple_carry_adder/full_adder.vhd alu_behavioral/alu-comp.vhdl alu_behavioral/ALUControl.vhdl alu_behavioral/shift.vhdl register_file/register_file.vhd register_file/register.vhd register_file/decoder.vhd register_file/zero.vhd register_file/tri-state_buffer.vhd datapath/datapath.vhd ctrl_unit/ctrl_unit.vhdl data_memory_async/data_memory.vhdl instr_mem-behavioral/ac_bib.vhdl instr_mem-behavioral/instr_mem.vhdl pc/pc.vhd processor_testbench.vhd
